...
extension BuildContextExtension on BuildContext {
  ...
  ScaffoldMessengerState warningNotification({
    ...
    final snackBar = SnackBar(
      content: Text(
        message,
        style: TextStyles.body(context: this, color: theme.backgroundColor),
      ),
  ...
  TextStyle textStyle17Medium({required Color color}) => GoogleFonts.roboto(
        textStyle: TextStyle(
          fontSize: 17.sp,
          fontWeight: FontWeight.w600,
          color: color,
  ...
  TextStyle textStyle17Regular({required Color color}) => GoogleFonts.roboto(
        textStyle: TextStyle(
          fontSize: 17.sp,
